...
<template>
    <nav
        class="fade-in-secondary fixed bottom-7 left-1/2 top-auto z-999 w-[88%] -translate-x-1/2 translate-y-0 rounded-full shadow-xl sm:w-max xl:h-max xl:w-auto xxl:left-auto xxl:right-12 xxl:top-1/2 xxl:translate-x-0 xxl:-translate-y-1/2 xxl:px-0">
        <ul
            class="flex flex-row items-center justify-between gap-4 rounded-full bg-nav-bg/20 px-8 py-4 backdrop-blur-sm xxl:flex-col xxl:px-4 xxl:py-8"
            ...
            <li
                ...
                :class="{
                    'bg-primary-accent object-cover hover:bg-primary-accent/90':
                        key === currentSection,
                    'hover:bg-nav-hover/20': key !== currentSection,
                }">
                <a
