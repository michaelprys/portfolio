<template>
    <svg
        ...
        <path
            fill="#111827"
            d="M15.73 9.63h19.98a8.4 8.4 0 0 1 8.65 8.14l.54 11.84c.06 5.88-4.23 8.28-9.19 8.32l-19.98.25c-5.14.04-8.24-3.81-8.14-8.57l.34-11.84c.31-5.21 2.59-8.04 7.8-8.14Z"></path>
        <path
            fill="url(#YpWK)"
            d="M2.59 0A2.59 2.59 0 1 1 0 2.59 2.59 2.59 0 0 1 2.59 0Z"
            transform="translate(34.23 19.25)"></path>
        <path
            fill="url(#YpWK)"
            d="M2.59 0A2.59 2.59 0 1 1 0 2.59 2.59 2.59 0 0 1 2.59 0Z"
            transform="translate(14.25 19.25)"></path>
    </svg>
</template>
